...
_In this installation, I will use password rootDBpass as root database password and zabbixDBpass as Zabbix proxy database password. Consider changing your password for security reasons.
In your terminal, use the following command to install MariaDB 10.6._
```
